...
const pairedZeroes = (arr) => {
    
    // Method #1 : Solution found on Codewars

    let seenZero = 0;
    return arr.filter(num => num !== 0 || seenZero++ % 2 === 0);
}

console.log(pairedZeroes([0, 1, 0, 0]));
console.log(pairedZeroes([1, 0, 7, 0, 1]));
console.log(pairedZeroes([0, 1, 7, 0, 2, 2, 0, 0, 1, 0]));